...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/oa/workflows/create',
        name: 'WorkflowCreate',
        component: () => import('@/views/oa/workflows/WorkflowCreate.vue'),
        meta: { title: '创建工作流', module: 'oa' },
      },
      {
        path: '/oa/workflows/:id/edit',
        name: 'WorkflowEdit',
        component: () => import('@/views/oa/workflows/WorkflowCreate.vue'),
        meta: { title: '编辑工作流', module: 'oa' },
      },
      {
        path: '/oa/workflows/:id/view',
        name: 'WorkflowView',
        component: () => import('@/views/oa/workflows/WorkflowCreate.vue'),
        meta: { title: '查看工作流', module: 'oa' },
      },
      {
        path: '/oa/workflows/:id/design',
        name: 'WorkflowDesign',
        component: () => import('@/views/oa/workflows/WorkflowCreate.vue'),
        meta: { title: '设计工作流', module: 'oa' },
      },
      {
      ...
      {
        path: '/oa/announcements/create',
        name: 'AnnouncementCreate',
        component: () => import('@/views/oa/announcements/AnnouncementCreate.vue'),
        meta: { title: '发布公告', module: 'oa' },
      },
      {
        path: '/oa/announcements/:id',
        name: 'AnnouncementDetail',
        component: () => import('@/views/oa/announcements/AnnouncementDetail.vue'),
        meta: { title: '公告详情', module: 'oa' },
      },
      {
        path: '/oa/announcements/:id/edit',
        name: 'AnnouncementEdit',
        component: () => import('@/views/oa/announcements/AnnouncementEdit.vue'),
        meta: { title: '编辑公告', module: 'oa' },
      },
      {
      ...
      },
      {
        path: '/oa/rooms',
        name: 'RoomList',
        component: () => import('@/views/oa/rooms/RoomList.vue'),
        meta: { title: '教室管理', module: 'oa' },
      },
      {
        path: '/oa/room-bookings/:id',
        name: 'BookingDetail',
        component: () => import('@/views/oa/rooms/BookingDetail.vue'),
        meta: { title: '预约详情', module: 'oa' },
      },
      {
        path: '/oa/assets',
        name: 'AssetList',
      ...
      {
        path: '/oa/assets/create',
        name: 'AssetCreate',
        component: () => import('@/views/oa/assets/AssetCreate.vue'),
        meta: { title: '新增资产', module: 'oa' },
      },
      {
        path: '/oa/assets/:id',
        name: 'AssetDetail',
        component: () => import('@/views/oa/assets/AssetDetail.vue'),
        meta: { title: '资产详情', module: 'oa' },
      },
      {
        path: '/oa/assets/:id/edit',
        name: 'AssetEdit',
        component: () => import('@/views/oa/assets/AssetCreate.vue'),
        meta: { title: '编辑资产', module: 'oa' },
      },
      {
        path: '/oa/assets/:id/history',
        name: 'AssetHistory',
        component: () => import('@/views/oa/assets/AssetDetail.vue'),
        meta: { title: '操作记录', module: 'oa' },
      },
      {
        path: '/oa/worklogs',
        name: 'WorklogList',
      ...
      {
        path: '/oa/worklogs/editor',
        name: 'WorklogEditor',
        component: () => import('@/views/oa/worklogs/WorklogEditor.vue'),
        meta: { title: '撰写日志', module: 'oa' },
      },
      {
        path: '/oa/worklogs/:id/edit',
        name: 'WorklogEdit',
        component: () => import('@/views/oa/worklogs/WorklogEditor.vue'),
        meta: { title: '编辑日志', module: 'oa' },
      },
      {
        path: '/oa/worklogs/team',
        name: 'TeamLogs',
        component: () => import('@/views/oa/worklogs/TeamLogs.vue'),
        meta: { title: '团队日志', module: 'oa' },
      },
      {
        path: '/oa/task-boards',
        name: 'TaskBoards',
      ...
      },
      {
        path: '/oa/projects',
        name: 'ProjectList',
        component: () => import('@/views/oa/tasks/ProjectList.vue'),
        meta: { title: '项目管理', module: 'oa' },
      },
    ],
  },
]
